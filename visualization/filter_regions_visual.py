...
os.makedirs(os.path.join(str(PROJECT_ROOT), "outputs/visualizations"), exist_ok=True)
OUTPUT_FILE = os.path.join(str(PROJECT_ROOT), "outputs/visualizations/filtered_regions_visual.png")
...
image_path = os.path.join(str(PROJECT_ROOT), f"data/{aoi}/2019_12.tif")
