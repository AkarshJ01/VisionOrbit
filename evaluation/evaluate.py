...
CHECKPOINT = os.path.join(str(PROJECT_ROOT), "checkpoints", "best_model.pth")
if not os.path.exists(CHECKPOINT):
    # fallback to best_interval model if baseline best_model.pth not present
    alt_ckpt = os.path.join(str(PROJECT_ROOT), "checkpoints", "best_model_best_interval.pth")
