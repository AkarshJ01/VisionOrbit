...
DEFAULT_ROOT = os.path.join(str(PROJECT_ROOT), "data/patches/long_interval")
ROOT = DEFAULT_ROOT if os.path.exists(DEFAULT_ROOT) else "long_interval_patches"

DEFAULT_CHECKPOINT = os.path.join(str(PROJECT_ROOT), "checkpoints", "best_model_long_interval.pth")
CHECKPOINT = DEFAULT_CHECKPOINT if os.path.exists(DEFAULT_CHECKPOINT) else "checkpoints/best_model_long_interval.pth"
