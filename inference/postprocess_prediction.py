...
DEFAULT_PATCH_ROOT = os.path.join(str(PROJECT_ROOT), "data/patches/best_interval")
PATCH_ROOT = DEFAULT_PATCH_ROOT if os.path.exists(DEFAULT_PATCH_ROOT) else "best_interval_patches"
...
out_dir = os.path.join(str(PROJECT_ROOT), "outputs/results")
os.makedirs(out_dir, exist_ok=True)
json_file = os.path.join(out_dir, "all_validation_change_results.json")
